...
public class SubjectService : ISubjectService
{
    ...
    public SubjectService(IUnitOfWorkRepository unitOfWork, IHttpContextAccessor httpContextAccessor,
    ...
    public async Task<GetSubjectDtos> GetSubjectByIdAsync(int id)
    {
        ...
        if (subject == null) throw new NotFoundException($"Subject with ID {id} not found.");
    ...
    {
        var subjectEntity = subjectCreateDto.Adapt<Subject>();
    ...
    public async Task<GetSubjectDtos> UpdateSubjectAsync(UpdateSubjectDtos subjectGetDto)
    {
        ...
        if (existingSubject == null) throw new NotFoundException($"Subject with ID {subjectGetDto.Id} not found.");
    ...
    public async Task<bool> DeleteSubjectAsync(int id)
    {
        ...
        if (existingSubject == null) throw new NotFoundException($"Subject with ID {id} not found.");
