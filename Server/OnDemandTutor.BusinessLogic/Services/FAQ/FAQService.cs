...
public class FAQService : IFAQService
{
    ...
    public FAQService(IUnitOfWorkRepository unitOfWorkRepository, INotificationService notificationService,
        IAuthServices authService, IHttpContextAccessor HttpContextAccessor)
    {
    ...
    public async Task<PagedResult<FAQDTO>> GetFAQsAsync(PagingModel<QueryFAQDTO> request)
    {
        ...
        if (pagedFAQs is null) throw new NotFoundException("FAQs not found.");
    ...
    public async Task<FAQDTO> GetFAQByIdAsync(int id)
    {
        ...
        if (faqEntity == null) throw new NotFoundException($"FAQ with ID {id} not found.");
    ...
    public async Task<UpdateFAQDto> UpdateFAQAsync(UpdateFAQDto faqDto)
    {
        ...
        if (existingFAQEntity == null) throw new NotFoundException($"FAQ with ID {faqDto.Id} not found.");
    ...
    public async Task<bool> DeleteFAQAsync(int id)
    {
        ...
        if (existingFAQEntity == null) throw new NotFoundException($"FAQ with ID {id} not found.");
