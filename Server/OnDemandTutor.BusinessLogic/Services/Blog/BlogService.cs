...
public class BlogService : IBlogService
{
    ...
    public async Task<GetBlogDtos> GetBlogByIdAsync(int id)
    {
        ...
        if (blogEntity == null) throw new NotFoundException($"Blog with ID {id} not found.");
    ...
    public async Task<UpdateBlogDtos> UpdateBlogAsync(UpdateBlogDtos blogDto)
    {
        ...
        if (existingBlogEntity == null) throw new NotFoundException($"Blog with ID {blogDto.Id} not found.");
    ...
    public async Task<bool> DeleteBlogAsync(int id)
    {
        ...
        if (existingBlogEntity == null) throw new NotFoundException($"Blog with ID {id} not found.");
