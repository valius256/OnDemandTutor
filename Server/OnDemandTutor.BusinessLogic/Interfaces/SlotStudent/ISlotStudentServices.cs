...
public interface ISlotStudentServices
{
    ...
    Task<GetSlotStudentDto> GetSlotStudentAsync(int slotId, int studentId);
    ...
    Task<GetSlotStudentDto> GetSlotStudentById(int slotId);
    ...
    Task<List<GetSlotStudentDto>> GetListSlotStudentByStudentId(int studentId);
