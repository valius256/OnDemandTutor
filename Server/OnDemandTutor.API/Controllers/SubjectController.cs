...
public class SubjectController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateSubject([FromBody] CreateSubjectDtos subjectCreateDto)
    {
        ...
        return CreatedAtAction(nameof(GetSubjectById), new { createdSubject.Id }, createdSubject);
    }
    ...
    {
        if (id != GetSubjectDtos.Id) return BadRequest("ID mismatch between route parameter and request body.");
