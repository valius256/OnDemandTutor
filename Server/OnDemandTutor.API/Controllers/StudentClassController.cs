...
public class StudentClassController : ControllerBase
{
    ...
    public async Task<ActionResult<PagedResult<GetStudentClassDetailDto>>> GetQueriedStudentClass(
        [FromQuery] PagingModel<QueryStudentClassDto> getStudentClassDetailDto)
    {
    ...
    public async Task<ActionResult<UpdateStudentClassDto>> UpdateStudentClass(
        [FromBody] UpdateStudentClassDto studentClassDto)
    {
