...
public class FAQController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateFAQ([FromBody] CreateFAQDto FAQDTO)
    {
        ...
        if (createdFaq == null) throw new BadRequestException("Failed to create FAQ.");
    ...
    public async Task<IActionResult> GetFAQs([FromQuery] PagingModel<QueryFAQDTO> pagingModel)
    {
        ...
        if (faqs == null) throw new BadRequestException("Failed to retrieve FAQs.");
        return Ok(faqs);
    }
    ...
    public async Task<IActionResult> GetFAQById(int id)
    {
        ...
        if (faq == null) throw new BadRequestException($"Failed to retrieve FAQ by ID {id}.");
        return Ok(faq);
    }
    ...
    public async Task<IActionResult> UpdateFAQ([FromBody] UpdateFAQDto FAQDTO)
    {
        ...
        if (updatedFaq == null) throw new BadRequestException("Failed to update FAQ.");
    ...
    public async Task<IActionResult> DeleteFAQ(int id)
    {
        ...
        if (!isDeleted) throw new BadRequestException($"Failed to delete FAQ with ID {id}.");
        return Ok(isDeleted);
    }
}