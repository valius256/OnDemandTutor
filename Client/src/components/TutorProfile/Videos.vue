<template>
    <div>
        ...
        <div class="flex justify-center">
            <button @click="toggleOpenUploadPopup" class="font-bold bg-blue-400 text-white rounded-lg hover:bg-blue-200 px-12 py-2">
                Đăng tải video mới
            </button>
        </div>
        <hr class="mt-4">
        ...
        <generic-popup v-if="isOpenUploadPopup" title="Tải video mới lên" :closeFunction="toggleOpenUploadPopup">
            <video-uploader :tutorId="currentUser.id" :close="toggleOpenUploadPopup" :action="fetchVideos"></video-uploader>
        </generic-popup>
    </div>
</template>
